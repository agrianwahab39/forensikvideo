...
# story.append(Paragraph(f"<b>Penilaian Keandalan Bukti:</b> <span style='{reliability_style}'>{reliability}</span>", styles['Normal']))
    ...
    validation_data = [
        ...
        # FIX: Gunakan .get() untuk menghindari KeyError jika result.summary tidak ada atau kosong
        ["Total Anomali", f"{result.summary.get('total_anomaly', 'N/A')} dari {result.summary.get('total_frames', 'N/A')} frame"],
